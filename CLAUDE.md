...
- `index.html` — homepage: hero, skills strip, featured product band, case study cards grid, about section, contact band
...
- `alertt/` — the working app that combines case studies 02 and 03 (see below)
